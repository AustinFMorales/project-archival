public class Inode {
    ...
    public short flag;				   // 0 = no FTEs pointing to Inode, not reading ("r") or writing ("w", "w+", or "a"), and keep file
									   // 1 = at least one FTE pointing to Inode, reading ("r"), and keep file
									   // 2 = at least one FTE pointing to Inode, writing ("w", "w+", or "a"), and keep file
									   // 3 = no FTEs pointing to Inode, not reading ("r") or writing ("w", "w+", or "a"), and delete file
									   // 4 = at least one FTE pointing to Inode, reading ("r"), and delete file
									   // 5 = at least one FTE pointing to Inode, writing ("w", "w+", or "a"), and delete file
